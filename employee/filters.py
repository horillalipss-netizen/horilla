...
class EmployeeFilter(HorillaFilterSet):
    ...
    def filter_queryset(self, queryset):
        ...
        Note: no reporting-manager scoping here — everyone may see the full
        employee list (managers included); limited vs full profile access is
        decided on the individual profile view.
        """
